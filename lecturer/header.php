        ...
        <div class="row">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="units.php" class="list-group-item list-group-item-action">Units</a>
                    <a href="classes.php" class="list-group-item list-group-item-action">Classes</a>
                    <a href="qr-code.php" class="list-group-item list-group-item-action">QR Code Generator</a>
                    <a href="attendance-records.php" class="list-group-item list-group-item-action">Attendance Record</a>
